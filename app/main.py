...
from config import QR_DIRECTORY
from routers import qr_code, oauth  # Make sure these imports match your project structure.
from services.qr_service import create_directory
