...
from config import SERVER_BASE_URL, SERVER_DOWNLOAD_FOLDER
...
def list_qr_codes(directory_path: Path) -> List[str]:
    ...
    Returns:
    - A list of filenames (str) for QR codes found # Import necessary modules and functions from FastAPI and the standard library
from fastapi import APIRouter, Depends, HTTPException, status
from fastapi.security import OAuth2PasswordBearer, OAuth2PasswordRequestForm
from datetime import timedelta
from config import ACCESS_TOKEN_EXPIRE_MINUTES  # Custom configuration setting
from schema import Token  # Import the Token model from our application
from utils.common import authenticate_user, create_access_token
